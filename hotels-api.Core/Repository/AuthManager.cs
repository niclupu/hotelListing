...
namespace hotels_api.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<IEnumerable<IdentityError>> Register(ApiUsersDto userDto)
        {
        ...
        public async Task<string> CreateRefreshToken()
        {
            ...
            var result = _userManager.SetAuthenticationTokenAsync(_user, "HotelListingApi", "RefreshToken", newRefreshToken);
